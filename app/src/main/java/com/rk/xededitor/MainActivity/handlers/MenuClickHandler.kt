            ...
            Id.git -> {
                ...
                ActionPopup(activity).apply {
                    addItem(
                        ...
                        ContextCompat.getDrawable(activity, drawable.sync),
                        pull,
                        listener,
                    )
                    addItem(
                        ...
                        ContextCompat.getDrawable(activity, drawable.upload),
                        push,
                        listener,
                    )
...
//                        icon = ContextCompat.getDrawable(activity, drawable.terminal),
//                        listener = {
...
//                        icon = ContextCompat.getDrawable(activity, drawable.outline_insert_drive_file_24),
//                        listener = {
//                            val intent = Intent(Intent.ACTION_CREATE_DOCUMENT)
//                            intent.addCategory(Intent.CATEGORY_OPENABLE)
//                            intent.setType("application/octet-stream")
